...
class NewItemTest(TestCase):
	...
	def test_can_save_a_POST_request_to_an_existing_list(self):
		...
		self.client.post(f'/list/{correct_list.id}/add_item', data={'item_text': 'A new item for existing list'})
	...
	def test_redirect_to_list_view(self):
		...
		response = self.client.post(f'/list/{correct_list.id}/add_item', data={'item_text': 'A new item for existing list'})
